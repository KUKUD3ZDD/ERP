...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/js/common/bootstrap/css/bootstrap.min.css">
...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="#" target="_blank" class="logo">
            <span class="index_top"><strong>蓝云ERP管理系统</strong></span>
        </a>
        <nav class="navbar navbar-static-top" style="background-color: #0C0C0C">
            <a class="sidebar-toggle">
                <span class="sr-only">切换</span>
            </a><span class="index_top"><strong>蓝云ERP管理系统</strong></span>
